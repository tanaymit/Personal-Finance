...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white border-b border-slate-200 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="lg:hidden flex items-center gap-2">
          <button
            ...
            className={`p-2 mr-2 hover:bg-slate-100 rounded-lg transition-transform duration-200 transform ${
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-lg flex items-center justify-center font-bold text-xs text-white">
              PF
            </div>
      ...
      {searchOpen && (
        <div className="mt-4 flex items-center bg-slate-100 rounded-lg px-4 py-2">
          <Search size={18} className="text-slate-400" />
          <input
            type="text"
            placeholder="Search transactions..."
      ...
      >
        ...
        />
        <aside
          className={`absolute left-0 top-0 bottom-0 w-64 bg-white border-r border-slate-200 p-4 transform transition-transform duration-300 ${
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold">FinanceDash</h2>
            </div>
